...
class PageControllerTest extends WebTestCase
{
    public function testAbout()
    {
        ...
        $this->assertEquals(1, $crawler->filter('h1:contains("About JC Blog")')->count());
        $this->assertEquals(1, $crawler->filter('p:contains("JC is learning Symfony2 and is creating its first application with this framework")')->count());
    }
